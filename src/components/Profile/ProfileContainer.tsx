...
export default connect<MapStateToPropsType, MapDispatchToPropsType, {}, AppStateType>(mapStateToProps, {setUserProfile, getUserProfile}) (WithUrlDataContainerComponent);
